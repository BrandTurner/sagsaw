          ...
          <div className="media-object">
            <div className="card-text-left">
              ...
              <p>
								...
								awareness by sharing successful life experiences through mentoring that brings
								together several generations of young girls and women whose life experiences
								transcend time. Through these mentor relationships we ensure that young girls are
								equipped with a healthy self-image to contribute to social importance and personal
								development.
              </p>
							Example
            </div>
            <div className="card-image">
              <h2 className="about-desc">
								SAVE A GIRL, SAVE A WORLD BELIEVES IN CELEBRATING THE SPIRIT OF SISTERLY LOVE BY
								LETTING OUR MEMBERS KNOW THAT THEY MATTER
              </h2>
            </div>
          </div>
          ...
          <div className="media-object">
            ...
            <div className="card-text-right">
              ...
              <p>
								...
								looks like. We want girls to really know that they are our legacy and next
								generation of leaders; that we care about them and how they show up, represent and
								appear in the world. We want to be their village and support system to navigate
								life's challenges and to share a roadmap based on our various real-life experiences.
								We want to do what we can to help young girls along their journey in life. Together,
								we assembled our professional resources along with our network of some of the
								brightest and most accomplished women from coast to coast to work with us as
								mentors; holding the idea of developing sisterhood with a younger generation to
								share knowledge and experiences would prove invaluable. It’s important that
								throughout our program, we really drive home the point - as mentors, we are there
								for the girls. If they need guidance, we are there whether it is for the year, or
								for a lifetime. We want to give these girls things that we wished we had. Our goal
								is to bring out the greatness in them and to let them know that we have their backs.
